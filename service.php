<?php include_once("partials/header.php"); ?>
                ...
                <div class="col-lg-12">
                    <div class="breadcumb-content">
                        ...
                        <ul class="breadcumb-menu">
                            <li><a href="index.html">Oikos</a></li>
    ...
    <!--==============================
        Service Area  
    ==============================-->
    <div class="project-area-1 space overflow-hidden">   
            ...
            <div class="row gy-30 justify-content-center">
                ...
                <div class="col-xl-9">
                    ...
                    <div class="row filter-active gy-4">
                        <!-- <div class="col-md-4 filter-item cat1 cat3">
                            <div class="project-card">
                                <div class="project-card-img">
                                    <img src="assets/img/project/1-1.jpg" alt="img">
                                </div>
                        ...
                        <div class="col-md-4 filter-item cat1 cat2">
                            <div class="project-card">
                                <div class="project-card-img">
                                    <img src="assets/img/project/1-2.jpg" alt="img">
                                </div>
                                <div class="project-card-details">
                                    <p class="project-card-subtitle"><a href="project-details.html">Climate</a></p>
                        ...
                        <div class="col-md-4 filter-item cat2 cat3">
                            <div class="project-card">
                                <div class="project-card-img">
                                    <img src="assets/img/project/1-3.jpg" alt="img">
                                </div>
                                <div class="project-card-details">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <div class="title-area text-center">
                        ...
                        <h2 class="sec-title">Preserving The Earth For Future Generations</h2>
                    </div>
                </div>
            </div>
            <div class="row gy-4 justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        ...
                        <div class="service-card_content">
                            <h3 class="service-card_title "><a href="service-details.html">Carbon Offsetting</a></h3>
                            <p class="service-card_text">This allows individuals and organizations to support their efforts to combat carbon climate change.</p>
                        </div>
                        <div class="service-card_img">
                            <img src="assets/img/service/service_1-1.jpg" alt="img">
                            <a href="service-details.html" class="btn">Read More <i class="fas fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        ...
                        <div class="service-card_content">
                            <h3 class="service-card_title "><a href="service-details.html">Energy Consulting</a></h3>
                            <p class="service-card_text">Energy consulting involves providing expert advice and guidance on energy-related matters.</p>
                        </div>
                        <div class="service-card_img">
                            <img src="assets/img/service/service_1-2.jpg" alt="img">
                            <a href="service-details.html" class="btn">Read More <i class="fas fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        ...
                        <div class="service-card_content">
                            <h3 class="service-card_title "><a href="service-details.html">Climate Adaptation</a></h3>
                            <p class="service-card_text">Refers to the adaptation process of human and natural systems in response to the impacts.</p>
                        </div>
                        <div class="service-card_img">
                            <img src="assets/img/service/service_1-3.jpg" alt="img">
                            <a href="service-details.html" class="btn">Read More <i class="fas fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <!-- <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        ...
                        <div class="service-card_content">
                            <h3 class="service-card_title "><a href="service-details.html">E-Waste Recycling</a></h3>
                            <p class="service-card_text">Refers to the adaptation process of human and natural systems in response to the impacts.</p>
                        </div>
                        <div class="service-card_img">
                            <img src="assets/img/service/service_1-3.jpg" alt="img">
